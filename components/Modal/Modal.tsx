  ...
  return modal.isOpen ? (
    <>
      ...
      <div className="hidden m:fixed m:inset-0 m:flex m:justify-center bg-white m:z-20 m:mt-[70px]">
        <div className="bg-white dark:bg-var-dark1 dark:rounded-none rounded-lg border border-nomad-black w-[480px] min-h-[600px] text-lg flex flex-col items-center p-6 relative">
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black dark:bg-opacity-50 bg-opacity-60 z-50 m:hidden">
        <div className="bg-white dark:bg-var-dark1 rounded-lg border border-nomad-black w-[480px] min-h-[600px] text-lg flex flex-col items-center p-6 relative">
          <div className="w-full flex justify-between items-center mb-5">
            <h2 className="text-[28px] font-bold">{modal.title}</h2>
            <CloseButtonBig onClick={closeModal} />
          </div>
